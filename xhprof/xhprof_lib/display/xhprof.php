...
function print_flat_data($url_params, $title, $flat_data, $sort, $run1, $run2, $limit) {
  ...
  include( "/var/www/html/xhprof/xhprof_lib/templates/profChart.phtml");
  include( "/var/www/html/xhprof/xhprof_lib/templates/profTable.phtml");
...
function full_report($url_params, $symbol_tab, $sort, $run1, $run2, $links) {
  ...
  if ($diff_mode) {
      ...
      include "/var/www/html/xhprof/xhprof_lib/templates/diff_run_header_block.phtml";

  } else {
      global $xhprof_runs_impl;
    include "/var/www/html/xhprof/xhprof_lib/templates/single_run_header_block.phtml";
  }
