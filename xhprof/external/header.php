...
if ($_xhprof['ext_name'] && $_xhprof['doprofile'] === true) {
    include_once dirname(__FILE__) . '//var/www/html/xhprof/xhprof_lib/utils/xhprof_lib.php';
    include_once dirname(__FILE__) . '//var/www/html/xhprof/xhprof_lib/utils/xhprof_runs.php';
