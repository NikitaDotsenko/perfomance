...
{
    include ("/var/www/html/xhprof/xhprof_lib/templates/header.phtml");
    displayXHProfReport($xhprof_runs_impl, $params, $params['source'], $params['run'], $params['wts'],
        $params['symbol'], $params['sort'], $params['run1'], $params['run2']);
}elseif (isset($_GET['geturl']))
{
    ...
    include ("/var/www/html/xhprof/xhprof_lib/templates/emptyBody.phtml");
...
include ("/var/www/html/xhprof/xhprof_lib/templates/footer.phtml");
